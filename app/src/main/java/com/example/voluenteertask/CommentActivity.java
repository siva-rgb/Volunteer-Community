...
import com.example.voluenteertask.Adapter.CommentAdapter;
import com.example.voluenteertask.Fragment.Model.Comments;
    ...
    private void getImage()
    {
        ...
        reference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                Glide.with(getApplicationContext()).load(user.getImageurl()).into(image_perofile);
            }
